...
{
    static Logger logger = Logger.getLogger(Assignment7.class.getName());
    ...
    public static class Map extends Mapper<Object, Text, NullWritable, Text> {
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            while (itr.hasMoreTokens()) {
                ...
                {
                    System.out.println("List _ Magic :"+list.contains(counter));
                    if(newStr.length()>0)
                        newStr+=",";
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(Assignment7.class);
